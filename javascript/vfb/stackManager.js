  ...
  if (parent.$("body").data("available")) {
    $("[id^=attach]").each(function(){
      ...
      if ($(this).html() === ""){
        ...
        content += "removeFromStackData('" + id + "');$('[id=attach]').html('');updateStackData();if (typeof updateMenuData !== 'undefined' && $.isFunction(updateMenuData)) {updateMenuData();};if (typeof updateWlzDisplay !== 'undefined' && $.isFunction(updateWlzDisplay)) {updateWlzDisplay();};";
