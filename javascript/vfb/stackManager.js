  ...
  $('#searchtext').typeahead({
    ...
    source: function(query, process){
        ...
        $.ajax({
            ...
            data: {hl:true, fl:'short_form,label,synonym,id,type,has_narrow_synonym_annotation,has_broad_synonym_annotation', start:0, fq:'ontology_name:(fbbt)', fq:'is_obsolete:false', fq:'shortform_autosuggest:VFB_* OR shortform_autosuggest:FBbt_*', rows:100, 'hl.simple.pre':'<b>', bq:'is_defining_ontology:true^100.0 label_s:"'+ query + '"^2 synonym_s:"'+ query + '" in_subset_annotation:BRAINNAME^3 short_form:FBbt_00003982^2', q:query, defType:'edismax', 'hl.simple.post':'</b>', qf:'label synonym label_autosuggest_ws label_autosuggest_e label_autosuggest synonym_autosuggest_ws synonym_autosuggest_e synonym_autosuggest shortform_autosuggest has_narrow_synonym_annotation has_broad_synonym_annotation', 'hl.fl':'label_autosuggest', 'hl.fl':'label', 'hl.fl':'synonym_autosuggest', 'hl.fl':'synonym', wt:'json', indent:true},
