...
AjaxSolr.ResultWidget = AjaxSolr.AbstractWidget.extend({
  ...
  template: function (doc) {
    ...
    if (doc.short_form[0].indexOf('VFB') > -1) {
      output += '<img align="right" src="/owl/' + doc.short_form[0].replace(':','_').replace('VFB_', 'VFBi_') + '/thumbnail.png" class="img-thumbnail" style="height: 40px; padding: 0px" data-holder-rendered="false" onerror="this.style.display = \'none\';">'
    }
    output += '<dt>' + doc.label;
