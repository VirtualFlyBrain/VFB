...
AjaxSolr.ResultWidget = AjaxSolr.AbstractWidget.extend({
  ...
  template: function (doc) {
    ...
    if (doc.short_form[0].contains('VFB')) {
      output += '<img align="right" src="/owl/' + doc.short_form[0].replace('VFB_', 'VFBi_') + '/thumbnail.png" class="img-thumbnail" style="height: 40px; padding: 0px" data-holder-rendered="false" >'
    }
    output += '<dt>' + doc.label;
