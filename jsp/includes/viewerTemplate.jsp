...
<div class="row">
	...
	<div class="span2" id="left-panel">
		<form class="form-inline">
			...
			<input id="slider-slice" class="span2" type="text" data-slider-min="0" data-slider-max="1024" data-slider-step="1" data-slider-value="0" data-slider-orientation="vertical"/>
		</form>
	</div>
