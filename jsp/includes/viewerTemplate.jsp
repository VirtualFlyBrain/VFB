...
<div class="row" style="overflow:scroll;">
	...
	<div class="col-md-7 col-lg-5" id="viewer-panel">
		<form class="form-inline">
			...
			<div class="text-muted hidden-xs" style="display:initial;" id="positionDiv"><span title="Image center" class="glyphicon glyphicon-screenshot"></span><small><span id="positionVal" title="Image currently centered on this point" class="badge">X,Y,Z</span></small></div>
		</form>
