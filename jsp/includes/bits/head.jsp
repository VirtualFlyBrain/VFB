	  ...
	  <div class="container-fluid">
	    ...
	    <div id="navbar-collapse-1" class="collapse navbar-collapse">
	      <ul class="nav navbar-nav">
	        <li class="dropdown">
	          <a href="#" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" role="button" aria-expanded="false"> Site <span class="caret"></span></a>
	        ...
	        <li class="dropdown"><a href="#" class="dropdown-toggle" data-toggle="dropdown" id="stacksMenu" data-hover="dropdown" role="button" aria-expanded="false">Stacks <span class="caret"></span></a>
	          <ul class="dropdown-menu" role="menu">
	            ...
	            <li id="openVFBt_001"><a onClick="forceStoreControl();addToStackData('VFBt_001');post('/site/stacks/index.htm',{'add':'VFBt_00100000'});">Open the Janelia Adult Brain <span id="CountVFBt_001" class="label label-warning label-as-badge"></span></a></li>
	            <li id="openVFBt_002"><a onClick="forceStoreControl();addToStackData('VFBt_002');post('/site/stacks/index.htm',{'add':'VFBt_00200000'});">Open the Ito Half Brain <span id="CountVFBt_002" class="label label-warning label-as-badge"></span></a></li>
							<li id="openVFBt_004"><a onClick="forceStoreControl();addToStackData('VFBt_004');post('/site/stacks/index.htm',{'add':'VFBt_00400000'});">Open the Ventral Nervous System <span id="CountVFBt_004" class="label label-warning label-as-badge"></span></a></li>
							<li id="openVFBt_003"><a onClick="forceStoreControl();addToStackData('VFBt_003');post('/site/stacks/index.htm',{'add':'VFBt_00300000'});">Open the Larval Brain <span id="CountVFBt_003" class="label label-warning label-as-badge"></span></a></li>
	          	<li id="clearAllOption"><a onClick="forceStoreControl();clearAllData();">Clear <span id="viewer2DVal" class="label label-success label-as-badge">*</span> items</a></li>
							...
							<li id="menuOpen3D"><a id="menuOpen3Dlink" href="http://129.215.164.244:8084/org.geppetto.frontend/geppetto?load_project_from_url=http://www.virtualflybrain.org/do/geppettoJson.json" target="_blank">Open <span id="viewer2DVal" class="label label-success label-as-badge">*</span> items in 3D viewer</a></li>
						</ul>
	        </li>
