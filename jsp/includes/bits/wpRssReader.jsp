...
<div style="background-color:#e3e3e3; font: 16px Arial; font-weight:bold; color:#333; margin-bottom: 6px; text-align: center;"> &nbsp;&nbsp;&nbsp;News Feed 
...
<div style="height:400px; overflow-y: auto; overflow-x: hidden;">
	...
	SimpleDateFormat formatter = new SimpleDateFormat("MMMM d, yyyy");%>
		<div style="padding:2px;background:#e3e3e3">
