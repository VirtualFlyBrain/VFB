...
<div style="background-color:#FFFFFF; font: 16px Arial; font-weight:bold; color:#333; margin-bottom: 6px; text-align: center;background:white"> &nbsp;&nbsp;&nbsp;News Feed 
...
<div style="height:250px; overflow-y: auto; overflow-x: hidden;">
	...
	SimpleDateFormat formatter = new SimpleDateFormat("MMMM d, yyyy");%>
		<div style="padding:2px;">
			...
			<p style="margin: 0; font-size:1.2em; font-weight:bold; background-color:#FFFFFF;"><a href="<%=getElementValue(element,"link")%>"><%=getElementValue(element,"title")%></a></p><br/>
