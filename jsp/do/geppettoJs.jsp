...
var setSepCol = function(path){ var c = coli;coli++;if (coli>199) {coli=0;};setTimeout(function() {Instances.getInstance(path).setColor(colours[c],true).setOpacity(0.8,true);if (c=0){Instances.getInstance(path).setOpacity(0.2,true);};}, 6000);}
