...
var setCol = function(c){setTimeout(function() {try{Instances.getInstance(path).setColor(colours[c],true).setOpacity(0.8,true);if (c<1){Instances.getInstance(path).setOpacity(0.2,true);};}catch (ignore){setCol(c);}}, 6000);};
var setSepCol = function(path){ var c = coli; coli++; if (coli>199) {coli=0;};setCol(c);};
