...
var getId = function(path){setTimeout(function() { window.Model.getDatasources()[0].fetchVariable(path);}, 4000); setTimeout(function() { Instances.getInstance(path+"."+path+"_meta"); }, 5000);};
