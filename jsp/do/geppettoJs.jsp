...
var setSepCol = function(path){ setTimeout(function() {Instances.getInstance(path).setColor(colours[coli],true).setOpacity(0.8,true);if (coli=0){Instances.getInstance(path).setOpacity(0.2,true);};coli++;if (coli>199) {coli=0;};}, 6000);}
