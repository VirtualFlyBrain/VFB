...
<c:forEach items="${domains}" var="curr" varStatus="status">
    <c:if test="${not empty curr}">
        //${domHead}<fmt:formatNumber minIntegerDigits="5" groupingUsed="false" value="${curr}"/>.setOpacity(0.5,true);
    </c:if>
</c:forEach>
