...
loading = false; timeout = []; timeout["max"] = 10; order = []; order["curr"] = 0; capacity = 10;
...
var delay=function(ms, func, param) { setTimeout(function(){ if (capacity > 0) {capacity--; func(param);}else{delay(500, func, param);}}, ms);}
