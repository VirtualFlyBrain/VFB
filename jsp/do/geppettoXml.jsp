  ...
  <dataSources
    ...
    <queries
      ...
      <queryChain
          ...
          countQuery="MATCH(i:Individual)-[:Related { label : 'depicts' } ]-(j:Individual)-[:Related { label : 'has_signal_channel' } ]-(k:Individual) WHERE i.short_form IN $ARRAY_ID_RESULTS RETURN count(i)"/>
      <queryChain
          xsi:type="gep_2:ProcessQuery"
          name="Process Images"
